...
In this Project we are trying to train and test a model for detecting various objects on the conveyor belt for recycling purposes. In order to detect objects we have used <a href="https://github.com/WongKinYiu/yolov7">Yolov7</a> model which is fast and accurate enough for our intention.
...
# Training Process
Although the results of training process are provided in <a href="./Weights" > Weights</a> folder but here is the process in case you want to try yourself.
...
The pretrained weights are obtained in Weights folder.

The dataset here has been obtained from Roboflow and is used like this:
```
...
```
Run this code in order to train your model:
```
$ cd yolov7
...
```
# Training Results
This Code will show the results of training.
```
...
<div align="center">
    <a href="./">
        <img src="./Figures/Losses.png" width="55%"/>
    </a>
</div>
...
<div align="center">
    <a href="./">
        <img src="./Figures/metrics.png" width="40%"/>
    </a>
</div>
...
<div align="center">
    <a href="./">
        <img src="./Figures/test_result.jpg" width="40%"/>
    </a>
</div>

# Exporting
In order to export .pt file as onnx format run this code:
```
$cd ..
